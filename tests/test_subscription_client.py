...
from lago_python_client.models import Subscription, Charge, ChargeFilter, FixedCharge
...
def mock_subscription_charge_response():
    this_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(this_dir, "fixtures/subscription_charge.json")
...
def mock_subscription_charges_response():
    this_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(this_dir, "fixtures/subscription_charges.json")
...
def mock_subscription_fixed_charge_response():
    this_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(this_dir, "fixtures/subscription_fixed_charge.json")
...
def mock_subscription_charge_filter_response():
    this_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(this_dir, "fixtures/subscription_charge_filter.json")
...
def mock_subscription_charge_filters_response():
    this_dir = os.path.dirname(os.path.abspath(__file__))
    data_path = os.path.join(this_dir, "fixtures/subscription_charge_filters.json")
...
def test_valid_find_charge_filter_request(httpx_mock: HTTPXMock):
    ...
    httpx_mock.add_response(
        method="GET",
        url="https://api.getlago.com/api/v1/subscriptions/" + external_id + "/charges/" + charge_code + "/filters/" + filter_id,
