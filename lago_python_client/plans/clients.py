...
class PlanClient(
    ...
    def find_all_charges(self, plan_code: str, options: Optional[dict] = None) -> Mapping[str, Any]:
        if options is None:
            options = {}
    ...
    def find_all_fixed_charges(self, plan_code: str, options: Optional[dict] = None) -> Mapping[str, Any]:
        if options is None:
            options = {}
        api_response: Response = send_get_request(
            url=make_url(
